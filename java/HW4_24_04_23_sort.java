...
public class HW4_24_04_23_sort {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // Далее. Есть простой способ .. скопировать один из "непрекосновенных" списков, например listage, и сортировать его
        // вместе со списком id ("пузырьком", как делали на семинаре), и вывести данные по полученному списку id.
